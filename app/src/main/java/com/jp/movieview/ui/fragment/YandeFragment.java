 ...
 */
public class YandeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Views.add(YandeTimeFragment.newInstance(0));
        Views.add(YandeTimeFragment.newInstance(1));
        Views.add(YandeTimeFragment.newInstance(2));
        Views.add(YandeTimeFragment.newInstance(3));
