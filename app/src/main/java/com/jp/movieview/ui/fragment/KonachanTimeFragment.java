...
import com.jp.movieview.presenter.KonachanDataPresenter;
 ...
 */
public class KonachanTimeFragment extends Fragment implements YandeItemView {
    ...
    public KonachanTimeFragment() {
        // Required empty public constructor
    }

    public static KonachanTimeFragment newInstance(int timeType) {
        KonachanTimeFragment newFragment = new KonachanTimeFragment();
    ...
    public KonachanTimeFragment(int timeType) {
        // Required empty public constructor
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        KonachanDataPresenter presenter = new KonachanDataPresenter(this);
        switch (timeType) {
            case 0:
